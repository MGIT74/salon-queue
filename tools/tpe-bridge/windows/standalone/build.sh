...
# tpe-bridge-win.js, config-wizard.ps1 et Configurer.bat, pour que
# l'installation ne necessite plus qu'un seul fichier telecharge.
# A relancer a chaque fois que l'un de ces 4 fichiers change.
set -euo pipefail
cd "$(dirname "$0")"
WIN_DIR=".."
...
sed -i 's/$/\r/' "$OUT"
rm -f core.b64 win.b64 wizard.b64 configurer.b64
